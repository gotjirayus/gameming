    ...
    <!--EndNavbar-->
       <?php
            ...
            if(isset($_POST['submit'])){
                ...
                $sql = "INSERT INTO `product` (`productname`, `image`, `price`,`st`) 
                VALUES ('".$_POST['productname']."','".$newName."','".$_POST['price']."','".$_POST['st']."');";
                ...
                if($resul){
                    echo '<script>swal({
                        title: "สำเร็จ",
                        text: "เพิ่มสินค้าเรียบร้อยแล้วแล้ว",
                        icon: "success",
                        button: "ตกลง"
                    ...
                    echo '<script>swal ( "ผิดพลาด" ,  "กรุณาเพิ่มสินค้าใหม่" ,  "error" )</script>';
                }
       ...
       <div class="container" style="height:600px;" >
                ...
                <div class="col-md-8 mx-auto mt-5">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" >
                        <div class="card-header text-center bg-light text-dark"><h2>
                            เพิ่มสินค้า&nbsp;<i class="fas fa-arrow-circle-up"></i></h2>
                        </div>
                        <div class="card-body bg-light text-dark">

                            <!-- Start Form เพิ่มรูป-->
                            <div class="text-center">
                                <img id ="imgUpload" src="pic/pro.png" style="width:250px; heigth:250px;" class="rounded" alt="...">
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control is-valid" id="name" name="productname" placeholder="Product Name" value="" required>
                                </div>
                                <div class="col">
                                <label for="lastname" class="col-form-label">ราคา</label>
                                    <input type="text" class="form-control is-valid" id="lastname" name="price" placeholder="Price" value="" required>
                                </div>
                                <div class="col">
                                <label for="lastname" class="col-form-label">จำนวน</label>
                                    <input type="number" class="form-control is-valid" id="st" name="st" placeholder="total" value="" required>
                                </div>
                            </div> 
        ...
        <!-- End Form -->
        <!--footer-->
        <br><div class="card-footer bg-dark text-light" align="center">
