...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <?php 
		...
		$sql1 = "INSERT INTO order1(idmember,total,	oderdate)VALUES('$c_id','$total','$order_date')";
		...
		$sql2="INSERT INTO order2(oderid,idproduct,total,qty)VALUES('.$ordersid.','.$item_id.','$item_price','$item_qty')";
			$result2=mysqli_query($conn,$sql2);
            
        $sql3="SELECT * FROM product Where idproduct=$item_id";
            $result3=mysqli_query($conn,$sql3);
            $row3=mysqli_fetch_assoc($result3);
            $st = $row3["st"];
            $st = $st-$item_qty;
        $sql4 = "UPDATE product SET st=$st WHERE idproduct=$item_id";
	...
	?>
        <!-- Start Form -->
        <br><br><br><br><div class="container"style="height:545px;">
            <div class="row">
                <div class="col-md-8 mx-auto mt-5">
                    <div class="card">
                    <form action="" method="post">
                        <div class="card-header text-center">
                            <h1>บันทึกรายการสั่งซื้อสินค้า</h1>
                        </div>
                            <div class="card-body text-center">
                               <h4> บันทึกรายเละเอียดการสั่งซื้อสินค้าเรียบร้อยแล้ว<br>
                               ทางเราจะจัดส่งสินค้าตามที่อยู่ภายใน 7-15 วัน<br>
                               และเรียกชำระเงินปลายทาง
                               <br><br>
                            </div>
                            <div class ="card-footer text-center bg-light text-dark">
                            <a href="index.php" class="btn btn-secondary btn-lg btn-block" role="button" aria-pressed="true">ตกลง</a>
