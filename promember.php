...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <?php 
         ...
         $id =  $_GET['id'];
         $sql = "SELECT * FROM order1 WHERE idmember = $id ";
         $test = mysqli_query($conn,$sql);
         
                    ?>

                    <div class="container" style="height:1000px;">
                    <br><h2 align="center">ประวัติการสั่งซื้อ</h2><br>
                    <table class="table table-bordered text-center" >
                <thead>
                    <tr class="bg-success">
                    <th scope="col">รหัสใบสั่งซื้อ</th>
                    <th scope="col">ราคารวม</th>
                    <th scope="col">วันที่-เวลา-ที่สั่ง</th>
                ...
                <tbody>
                    ...
                    <td><?=$row["total"]?></td>
                    <td><?=$row["oderdate"]?></td>
                    <td><a href="pdf.php?id=<?=$row["oderid"]?>">Print</a></td>
                    </tr>
                </tbody>
